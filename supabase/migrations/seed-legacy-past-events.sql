...
VALUES
  ...
  ('legacy-gcc-4', '4th GCC Leadership Conclave — Hyderabad', '2025-11-13', '2025-11-14', 'ITC Kohenur, Hyderabad, India', '1,000+ attendees over two days at ITC Kohenur, featuring keynotes, panel discussions, and the GCC Excellence Awards.', 'completed', 'GCC Leadership Conclave', 'https://gcc4.theleadershipfederation.com/'),
  ('legacy-gcc-3', '3rd GCC Leadership Conclave — Bengaluru', '2025-09-03', '2025-09-03', 'Bengaluru, India', '300+ CXOs convened in Bengaluru to discuss innovation, leadership excellence, and global capability center strategies.', 'completed', 'GCC Leadership Conclave', 'https://gcc3.theleadershipfederation.com/'),
  ...
  ('legacy-ala-7', '7th Asia Leadership Awards — Kuala Lumpur', '2025-07-04', '2025-07-04', 'Aloft KL Sentral, Kuala Lumpur, Malaysia', 'Recognising outstanding leaders across Asia at the prestigious Aloft KL Sentral in Malaysia''s capital.', 'completed', 'Asia Leadership Awards', 'https://theleadershipfederation.com/7th-asia-leadership-awards-kuala-lumpur-malaysia'),
  ...
  ('legacy-ala-5', '5th Asia Leadership Awards — Mumbai', '2024-12-05', '2024-12-05', 'Radisson Blu International Airport Hotel, Mumbai, India', 'Celebrating leadership excellence in India''s financial capital with 200+ CXOs and industry trailblazers.', 'completed', 'Asia Leadership Awards', 'https://theleadershipfederation.com/5th-asia-leadership-awards-mumbai'),
