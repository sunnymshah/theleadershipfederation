...
export function LeadImportModal({ members, onClose, onDone }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-white rounded-xl border border-[#ededf0] shadow-[0_4px_20px_rgba(15,23,42,0.07)] w-full max-w-[780px] max-h-[90vh] flex flex-col overflow-hidden">
        {/* Header */}
