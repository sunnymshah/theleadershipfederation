...
function SpeakerCard({ name, role, initials }: { name: string; role: string; initials: string }) {
  return (
    <div className="mx-3 shrink-0 flex items-center gap-3.5 px-5 py-3 rounded-2xl bg-white/[0.03] border border-white/[0.05] hover:border-[#e7ab1c]/20 hover:bg-[#e7ab1c]/[0.03] transition-all duration-500 group">
      <div className="w-11 h-11 rounded-full bg-gradient-to-br from-[#e7ab1c]/20 to-[#e7ab1c]/5 flex items-center justify-center shrink-0 group-hover:from-[#e7ab1c]/30 group-hover:to-[#e7ab1c]/10 transition-all duration-500">
...
export function SpeakerMarquee() {
  const doubled1 = [...speakersRow1, ...speakersRow1]
  const doubled2 = [...speakersRow2, ...speakersRow2]
