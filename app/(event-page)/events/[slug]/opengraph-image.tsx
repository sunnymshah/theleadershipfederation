/**
 * Auto-generated OG image for every event microsite.
 * Used when settings.seo.ogImage isn't set — falls back to a branded
 * card with title + date + venue.
 */
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <div
            style={{
              ...
              maxWidth: 1000, color: "#fff",
            }}
          >
            {title}
          </div>
          {dateStr ? (
            <div style={{ fontSize: 24, color: "#e7ab1c", fontWeight: 600 }}>
              {dateStr}
            </div>
          ) : null}
          {venue ? (
        ...
        <div
          style={{
            ...
            fontSize: 16, color: "rgba(255,255,255,0.55)", letterSpacing: 1,
          }}
        >
